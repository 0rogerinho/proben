...
export const DigitalPromptService = () => {
  return (
    <div className="bg-gradient-to-l pb-0 from-light-blue to-dark-blue">
      <BaseLayout className="relative pb-0 text-white pt-8 gap-6 lg:flex-row lg:justify-between lg:py-20">
